...
@WebServlet("/Evenementexter")
public class Evenementexter  extends HttpServlet{
...
//on  renvoie l'utilisateur vers la page html
        templateEngine.process("Evenementexter", context, resp.getWriter());
        ...
        out.println("                    <a href=\"Evenement\" class=\"arena-bar-item arena-button active\">Evènements exter-HEI</a>");
